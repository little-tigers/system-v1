...
public class PageBounds extends RowBounds implements Serializable {
    ...
    public PageBounds(int pageNumber, int pageSize) {
        this(pageNumber, pageSize, new ArrayList<OrderBy>(), true);
    }
    ...
    public PageBounds(int pageNumber, int limit, boolean containsTotalCount) {
        this(pageNumber, limit, new ArrayList<OrderBy>(), containsTotalCount);
    }
    ...
    public PageBounds(int pageNumber, int pageSize, OrderBy... order) {
        this(pageNumber, pageSize, Arrays.asList(order), true);
    }

    public PageBounds(int pageNumber, int pageSize, List<OrderBy> orders) {
        this(pageNumber, pageSize, orders, true);
    }

    public PageBounds(int pageNumber, int pageSize, List<OrderBy> orders, boolean containsTotalCount) {
